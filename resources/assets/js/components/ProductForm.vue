    ...
    export default {
        ...
        methods: {
            ...
            createCategory() {
                ...
                axios.post(this.api.createCategory, this.newCat).then((res) => {
                    ...
                    if (res.data.success) {
                        ...
                        this.categories.push(res.data.cat);
                        // select new category as post category
                        this.product.category_id = res.data.cat.id;
            ...
            createTag() {
                axios.post(this.api.createTag, this.newTag)
                    .then((res) => {
                        ...
                        this.product.tags.push(res.data.tag.sanitized);
                        this.newTag.name = "";
                    })
                    .catch((error) => {
                        //
            ...
            updateProduct() {
                if (!this.validatePost()) return;
                this.product.description_md = this.postEditor.value();
                axios.post(this.api.updateProduct, this.product)
                    .then((res) => {
                        // success
                        if (res.data.success) {
